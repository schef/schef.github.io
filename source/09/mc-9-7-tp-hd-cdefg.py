...
#c major scale
print ("Exercise 9-7:")
print ("C, D, E, F and G. Harmonic and melodic pitch indentification. Harmonic doubles.")
...
notes = [ 36, 38, 40, 41, 43, 48, 50, 52, 53, 55, 60, 62, 64, 65, 67, 72, 74, 76, 77, 79, 84, 86, 88, 89, 91, 96 ]
