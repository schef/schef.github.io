...
#c major scale
print ("Exercise 10-8:")
print ("Decending melodic fours pitch indetification drill. Were not singing the tone. We only identify them.")
...
try:
  print(usage)
  while True:
    noteOne = random.choice(notes[3:])
    noteTwo = notes[notes.index(noteOne)-3]
    #while True:
    match = False
    while not match:
      done = False
