...
#c major scale
print ("Exercise 10-4:")
print ("Acending melodic fifts pitch indetification drill. Were not singing the tone. We only identify them.")
...
try:
  print(usage)
  while True:
    noteOne = random.choice(notes[:-4])
    noteTwo = notes[notes.index(noteOne)+4]
    #while True:
    match = False
    while not match:
      done = False
