...
#c major scale
print ("Exercise:")
print ("Three tones wide. Reach out, play two tones in one hand and one tone in the other hand.")
...
try:
 while True:
  intervalOne = random.randint(1, 11)
  intervalTwo = random.randint(1, len(notes)-intervalOne)
  match = False
  while not match:
